...
<form id="registration-form" @submit.prevent="validate">
  <div class="row">
    <div class="form-group col-lg-6" :class="{'has-error': errors.has('firstName')}">
      ...
      <input type="text" id="firstName" class="form-control" name="firstName" placeholder="First Name" tabindex="0" v-model="registration.firstName" v-validate.initial="registration.firstName" data-vv-rules="required">
    ...
    <div class="form-group col-lg-6" :class="{'has-error': errors.has('lastName')}">
      ...
      <input type="text" id="lastName" class="form-control" name="lastName" placeholder="Last Name" tabindex="0" v-model="registration.lastName" v-validate.initial="registration.lastName" data-vv-rules="required">
    ...
    <div class="form-group col-lg-6" :class="{'has-error': errors.has('username')}">
      ...
      <input type="text" id="username" class="form-control" name="username" placeholder="User Name" tabindex="0" v-model="registration.username" v-validate.initial="registration.username" data-vv-rules="required">
    ...
    <div class="form-group col-lg-6" :class="{'has-error': errors.has('email')}">
      ...
      <input type="email" value="" id="email" class="form-control" name="email" placeholder="Email" tabindex="0" v-model="registration.email" v-validate.initial="registration.email" data-vv-rules="required|email">
    ...
    <div class="form-group col-lg-6" :class="{'has-error': errors.has('password')}">
      ...
      <input type="password" id="password" class="form-control" name="password" placeholder="Password" tabindex="0" v-model="registration.password" v-validate.initial="registration.password" data-vv-rules="required">
    ...
    <div class="form-group col-lg-6" :class="{'has-error': errors.has('repeatPassword')}">
      ...
      <input type="password" id="repeatPassword" class="form-control" name="repeatPassword" placeholder="Repeat Password" tabindex="0" v-model="registration.repeatPassword" v-validate.initial="registration.repeatPassword" data-vv-rules="required|confirmed:password">
