<template>
<div v-once>
  <h2>derprecated, LLC Terms of Service and Privacy Policy</h2>

  <h3>1. Terms</h3>

  <p>By accessing the website at <a href="https://inventory.derprecated.com">https://inventory.derprecated.com</a>,
  ...
  <ol type="a">
    <li>
      ...
      or software) on derprecated, LLC's website for personal, non-commercial transitory
      ...
      <ol type="i">
        ...
        <li>attempt to decompile or reverse engineer any software contained on derprecated,
          LLC's website;</li>
    ...
    <li>This license shall automatically terminate if you violate any of these restrictions
      and may be terminated by derprecated, LLC at any time. Upon terminating your
  ...
  <ol type="a">
    <li>The materials on derprecated, LLC's website are provided on an 'as is' basis.
      derprecated, LLC makes no warranties, expressed or implied, and hereby disclaims
    ...
    <li>Further, derprecated, LLC does not warrant or make any representations concerning
  ...
  <p>In no event shall derprecated, LLC or its suppliers be liable for any damages (including,
    without limitation, damages for loss of data or profit, or due to business interruption)
    arising out of the use or inability to use the materials on derprecated, LLC's
    website, even if derprecated, LLC or a derprecated, LLC authorized representative
  ...
  <p>The materials appearing on derprecated, LLC's website could include technical,
    typographical, or photographic errors. derprecated, LLC does not warrant that
    any of the materials on its website are accurate, complete or current. derprecated,
    LLC may make changes to the materials contained on its website at any time without
    notice. However derprecated, LLC does not make any commitment to update the materials.</p>

  <h3>6. Links</h3>

  <p>derprecated, LLC has not reviewed all of the sites linked to its website and is
    not responsible for the contents of any such linked site. The inclusion of any
    link does not imply endorsement by derprecated, LLC of the site. Use of any such
    linked website is at the user's own risk.</p>

  <h3>7. Modifications</h3>

  <p>derprecated, LLC may revise these terms of service for its website at any time
  ...
  <p>These terms and conditions are governed by and construed in accordance with the
    laws of Colorado and you irrevocably submit to the exclusive jurisdiction of
    the courts in that State or location.</p>

  <h2>Privacy Policy</h2>

  <p>Your privacy is important to us.</p>

  <p>It is derprecated, LLC's policy to respect your privacy regarding any information
    we may collect while operating our website. Accordingly, we have developed this
  ...
  <ul>
    ...
    <li>We will collect and use personal information solely for fulfilling those purposes
      specified by us and for other ancillary purposes, unless we obtain the consent
      of the individual concerned or as required by law.</li>
    <li>Personal data should be relevant to the purposes for which it is to be used,
      ...
      and up-to-date.</li>
    <li>We will protect personal information by using reasonable security safeguards
    ...
    <li>We will only retain personal information for as long as necessary for the fulfilment
      of those purposes.</li>
  </ul>

  <p>We are committed to conducting our business in accordance with these principles
    in order to ensure that the confidentiality of personal information is protected
    and maintained. derprecated, LLC may change this privacy policy from time to
    time at derprecated, LLC's sole discretion.</p>
</div>
